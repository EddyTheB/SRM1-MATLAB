classdef SettingsDialogue < handle
    ...
    methods
        ...
        function app = SettingsDialogue(varargin)
            ...
            % number between 99900 and 99999.
            fNum = 99900;
            while ishghandle(fNum)
                fNum = fNum + 1;
                if fNum > 99999
                    error('SRM1:SettingsDialogue:fNumTooLarge', 'No available figure numbers left.')
                end
            end
            app.Figure = figure(fNum);
            set(app.Figure, 'ToolBar', 'none',  ...
                'MenuBar', 'none', ...
                'Name', 'SRM1 Settings', ...
                'NumberTitle', 'off', ...
                'Units', 'Pixels', ...
            ...
            app.ControlsPanel.EmissionYearsDropDown = uicontrol('Style', 'popupmenu', ...
                'Parent', app.ControlsPanel.Panel, ...
                'String', '---', ...
        ...
        function val = get.EmissionYearI(app)
            [~, val] = ismember(app.DisplayObject.Model.EmissionFactorYear, app.EmissionFactorYears);
        end % function val = get.EmissionI(app)
        ...
        function val = get.EmissionFactorYears(app)
            NN = app.DisplayObject.Model.EmissionFactorClassName;
            val = app.DisplayObject.Model.EmissionFactorCatalogue.FactorCatalogue.(NN).YearVs;
        end % function val = get.EmissionFactors(app)
        ...
        function SetValues(app)
            ...
            set(app.ControlsPanel.EmissionYearsDropDown, 'String', app.EmissionFactorYears, 'Value', app.EmissionYearI)
        ...
        function ChangeValues(app, Sender, ~)
            ...
            switch Sender
                ...
                case app.ControlsPanel.EmissionYearsDropDown
                    NewValue = get(Sender, 'Value');
                    NewValue = app.EmissionFactorYears(NewValue);
                    app.DisplayObject.Model.EmissionFactorYear = NewValue;
